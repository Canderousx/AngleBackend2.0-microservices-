...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(SolutionDoesNotExistException.class)
    public ResponseEntity<ServerMessage> handleSolutionDoesNotExistException(SolutionDoesNotExistException e){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ServerMessage(e.getMessage()));
    }

    @org.springframework.web.bind.annotation.ExceptionHandler(TypeDoesNotExistException.class)
    public ResponseEntity<ServerMessage> handleTypeDoesNotExistException(TypeDoesNotExistException e){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ServerMessage(e.getMessage()));
    }
